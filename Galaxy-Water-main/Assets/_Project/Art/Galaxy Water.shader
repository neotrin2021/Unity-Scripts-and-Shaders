	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 Vertex_Offset46 = ( ( inputMesh.normalOS * Noise_Vertex_Offset60 ) + Wave187 );
						 ...
						 )
			{
				...
				float4 Colour21 = ( _Colour * packedInput.ase_color );
				...
				float temp_output_20_0_g5 = Noise_Colour53;
				float3 normalizeResult130_g5 = normalize( ( ( abs( dotResult115_g5 ) * NormalWS ) - ( _NoiseNormalFromHeight * float3( 0.05,0.05,0.05 ) * sign( dotResult115_g5 ) * ( ( ddx( temp_output_20_0_g5 ) * temp_output_113_0_g5 ) + ( ddy( temp_output_20_0_g5 ) * cross( NormalWS , temp_output_111_0_g5 ) ) ) ) ) );
				...
				float3 Normal77 = BlendNormal( worldToTangentDir42_g5 , Wave_Normal188 );
				
				float ase_depthLinearEye = LinearEyeDepth( ScreenPos.z / ScreenPos.w, _ZBufferParams );
				float depthLinearEye28_g2 = LinearEyeDepth( SampleCameraDepth( ScreenPosNorm.xy ), _ZBufferParams );
				...
				float depthLinearEye2_g2 = LinearEyeDepth( SampleCameraDepth( ( float4( temp_output_20_0_g2, 0.0 , 0.0 ) + ScreenPosNorm ).xy ), _ZBufferParams );
				...
				float screenDepth85 = LinearEyeDepth(SampleCameraDepth( ScreenPosNorm.xy ),_ZBufferParams);
				...
				float screenDepth62 = LinearEyeDepth(SampleCameraDepth( ScreenPosNorm.xy ),_ZBufferParams);
				...
				surfaceDescription.BaseColor = Colour21.rgb;
				surfaceDescription.Normal = Normal77;
				...
				surfaceDescription.Emission = Emission69;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_output_111_0_g5 = ddx( ase_positionWS );
				float3 ase_normalWS = packedInput.ase_texcoord3.xyz;
				float3 temp_output_113_0_g5 = cross( ddy( ase_positionWS ) , ase_normalWS );
				float dotResult115_g5 = dot( temp_output_111_0_g5 , temp_output_113_0_g5 );
				float3 appendResult25 = (float3(ase_positionWS.x , ase_positionWS.z , ase_positionWS.y));
				float3 World_Position_XZY26 = appendResult25;
				float3 Noise_UV44 = ( ( ( World_Position_XZY26 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				...
				float Noise_Colour53 = ( pow( Noise29 , _NoiseColourPower ) + smoothstepResult202 );
				float temp_output_20_0_g5 = Noise_Colour53;
				float3 normalizeResult130_g5 = normalize( ( ( abs( dotResult115_g5 ) * ase_normalWS ) - ( _NoiseNormalFromHeight * float3( 0.05,0.05,0.05 ) * sign( dotResult115_g5 ) * ( ( ddx( temp_output_20_0_g5 ) * temp_output_113_0_g5 ) + ( ddy( temp_output_20_0_g5 ) * cross( ase_normalWS , temp_output_111_0_g5 ) ) ) ) ) );
				...
				float ase_depthLinearEye = LinearEyeDepth( screenPos.z / screenPos.w, _ZBufferParams );
				float depthLinearEye28_g2 = LinearEyeDepth( SampleCameraDepth( ase_positionSSNorm.xy ), _ZBufferParams );
				float2 temp_output_20_0_g2 = ( (Normal77).xy * ( _NoiseDistortion / max( ase_depthLinearEye , 0.1 ) ) * saturate( ( depthLinearEye28_g2 - ase_depthLinearEye ) ) );
				float depthLinearEye2_g2 = LinearEyeDepth( SampleCameraDepth( ( float4( temp_output_20_0_g2, 0.0 , 0.0 ) + ase_positionSSNorm ).xy ), _ZBufferParams );
				...
				float2 Screen_UV115 = lerpResult136;
				float3 _CameraOpaqueTextureColour19 = (tex2D( _CameraOpaqueTexture, Screen_UV115 )).rgb;
				float screenDepth85 = LinearEyeDepth(SampleCameraDepth( ase_positionSSNorm.xy ),_ZBufferParams);
				float distanceDepth85 = saturate( ( screenDepth85 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( _DepthColour ) );
				float smoothstepResult87 = smoothstep( 0.0 , 1.0 , pow( distanceDepth85 , _DepthColourPower ));
				float Depth_Colour88 = ( 1.0 - smoothstepResult87 );
				float3 lerpResult93 = lerp( _DeepColour.rgb , ( _ShallowColour.rgb + _CameraOpaqueTextureColour19 ) , ( _ShallowColour.a * Depth_Colour88 ));
				float3 lerpResult97 = lerp( lerpResult93 , _NoiseColour.rgb , ( _NoiseColour.a * Noise_Colour53 ));
				float screenDepth62 = LinearEyeDepth(SampleCameraDepth( ase_positionSSNorm.xy ),_ZBufferParams);
				...
				float3 temp_cast_5 = (_SurfaceTextureRemapMin).xxx;
				float3 temp_cast_6 = (_SurfaceTextureRemapMax).xxx;
				float2 uv_SurfaceTexture = packedInput.ase_texcoord7.xy * _SurfaceTexture_ST.xy + _SurfaceTexture_ST.zw;
				float3 temp_output_111_0_g4 = ddx( ase_positionWS );
				float3 temp_output_113_0_g4 = cross( ddy( ase_positionWS ) , ase_normalWS );
				float dotResult115_g4 = dot( temp_output_111_0_g4 , temp_output_113_0_g4 );
				float simplePerlin3D152 = snoise( ( ( World_Position_XZY26 * _SurfaceTextureNoiseScale ) - ( _SurfaceTextureNoiseAnimation * _TimeParameters.x ) ) );
				simplePerlin3D152 = simplePerlin3D152*0.5 + 0.5;
				float temp_output_20_0_g4 = simplePerlin3D152;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float3 temp_output_111_0_g5 = ddx( PositionWS );
				float3 ase_normalWS = packedInput.ase_texcoord3.xyz;
				float3 temp_output_113_0_g5 = cross( ddy( PositionWS ) , ase_normalWS );
				float dotResult115_g5 = dot( temp_output_111_0_g5 , temp_output_113_0_g5 );
				float3 appendResult25 = (float3(PositionWS.x , PositionWS.z , PositionWS.y));
				float3 World_Position_XZY26 = appendResult25;
				float3 Noise_UV44 = ( ( ( World_Position_XZY26 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;75;-1792,768;Inherit;False;Normal From Height;-1;;5;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-2176,0;Inherit;True;Global;_CameraOpaqueTexture;_CameraOpaqueTexture;17;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;204;0;22;0
WireConnection;204;1;78;0
WireConnection;204;4;17;0
WireConnection;204;7;18;0
WireConnection;204;6;70;0
WireConnection;204;11;47;0
ASEEND*/
//CHKSM=C87357CC1921CF27E879A81ED4DA45FE5876F7BC