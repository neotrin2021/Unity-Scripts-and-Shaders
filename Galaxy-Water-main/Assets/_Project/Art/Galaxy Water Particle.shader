	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult148 = (float4(inputMesh.uv0.z , inputMesh.uv0.w , inputMesh.uv1.x , 0.0));
						 ...
						 )
			{
				...
				float4 appendResult148 = (float4(packedInput.ase_texcoord5.z , packedInput.ase_texcoord5.w , packedInput.uv1.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
				...
				float4 Colour21 = ( lerpResult158 * packedInput.ase_color * tex2D( _Texture, uv_Texture ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 appendResult148 = (float4(packedInput.ase_texcoord2.z , packedInput.ase_texcoord2.w , packedInput.ase_texcoord3.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult148 = (float4(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord.w , inputMesh.ase_texcoord1.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
						 ...
						 )
			{
				...
				float4 appendResult148 = (float4(packedInput.ase_texcoord3.z , packedInput.ase_texcoord3.w , packedInput.ase_texcoord4.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult148 = (float4(inputMesh.uv0.z , inputMesh.uv0.w , inputMesh.ase_texcoord1.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
		...
		Pass
		{
					 ...
					 )
			{
				...
				float4 appendResult148 = (float4(packedInput.ase_texcoord7.z , packedInput.ase_texcoord7.w , packedInput.uv1.x , 0.0));
				float4 Particle_Center147 = appendResult148;
				float3 Particle_Center_XZY154 = (Particle_Center147).xzy;
				float3 Noise_UV44 = ( ( ( Particle_Center_XZY154 * _NoiseScale ) * _NoiseTiling ) - ( _NoiseAnimation * _TimeParameters.x ) );
				float time23 = (Noise_UV44).z;
...
WireConnection;175;0;22;0
WireConnection;175;9;141;0
WireConnection;175;11;135;0
ASEEND*/
//CHKSM=F634F133961308482BDB8291D6CC84770FC09F59